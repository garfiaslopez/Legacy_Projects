...
- (void)viewDidLoad
{
    ...
    [unidadesintensidad setTitleTextAttributes:attributes forState:UIControlStateNormal];
    
    [unidadesvoltaje setTitleTextAttributes:attributes forState:UIControlStateNormal];
   ...
   /* unidad.font = [UIFont fontWithName:@"GENERATION" size:15];
    unidad1.font = [UIFont fontWithName:@"GENERATION" size:15];
    unidad2.font = [UIFont fontWithName:@"GENERATION" size:15];*/
