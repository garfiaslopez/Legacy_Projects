...
- (void)viewDidLoad
{
    ...
    [Letra setTitleTextAttributes:attributes
                            forState:UIControlStateNormal];
    [NumeroyLetra setTitleTextAttributes:attributes
                         forState:UIControlStateNormal];
    
    tolerancialabel.font = [UIFont fontWithName:@"Coming Soon" size:15];
    voltajelabel.font = [UIFont fontWithName:@"Coming Soon" size:15];
    /*
    marcalabel.font = [UIFont fontWithName:@"GENERATION" size:15];
    
    picolabel.font = [UIFont fontWithName:@"GENERATION" size:20];
    nanolabel.font = [UIFont fontWithName:@"GENERATION" size:20];
    microlabel.font = [UIFont fontWithName:@"GENERATION" size:20];
*/
