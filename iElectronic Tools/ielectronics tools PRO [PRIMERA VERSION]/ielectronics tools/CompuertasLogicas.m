...
- (void)viewDidLoad
{
    ...
    [A setTitleTextAttributes:attributes
                            forState:UIControlStateNormal];
    [B setTitleTextAttributes:attributes
                     forState:UIControlStateNormal];
    ...
    Yeslabel.font = [UIFont fontWithName:@"Coming Soon" size:30];
    Nolabel.font = [UIFont fontWithName:@"Coming Soon" size:30];
    Andlabel.font = [UIFont fontWithName:@"Coming Soon" size:30];
    Orlabel.font = [UIFont fontWithName:@"Coming Soon" size:30];
    Nandlabel.font = [UIFont fontWithName:@"Coming Soon" size:30];
    Norlabel.font = [UIFont fontWithName:@"Coming Soon" size:30];
    Xnorlabel.font = [UIFont fontWithName:@"Coming Soon" size:30];
    Xorlabel.font = [UIFont fontWithName:@"Coming Soon" size:30];
    Alabel.font = [UIFont fontWithName:@"Coming Soon" size:20];
    Blabel.font = [UIFont fontWithName:@"Coming Soon" size:20];
    entradas.font = [UIFont fontWithName:@"Coming Soon" size:20];
