...
- (void)viewDidLoad
{
    ...
    [UnidadBobina setTitleTextAttributes:attributes
                            forState:UIControlStateNormal];
    [UnidadCapacitor setTitleTextAttributes:attributes
                            forState:UIControlStateNormal];
    [UnidadFrecuencia setTitleTextAttributes:attributes
                            forState:UIControlStateNormal];
    
    [self.TituloNav setTitleTextAttributes:@{UITextAttributeFont:[UIFont fontWithName:@"Coming Soon" size:15]}];
    ...
    CapacitorLabel.font = [UIFont fontWithName:@"Coming Soon" size:25];
    BobinaLabel.font = [UIFont fontWithName:@"Coming Soon" size:25];
    FrecuenciaLabel.font = [UIFont fontWithName:@"Coming Soon" size:25];
    CapacitivaLabel.font = [UIFont fontWithName:@"Coming Soon" size:25];
    InductivaLabel.font = [UIFont fontWithName:@"Coming Soon" size:25];
    ResonanciaLabel.font = [UIFont fontWithName:@"Coming Soon" size:25];
