...
-(IBAction)InicioDiagramas:(id)sender{
   ...
   // iniciodiagramas = [self.storyboard instantiateViewControllerWithIdentifier:@"Diagramas"];
  //  iniciodiagramas.modalTransitionStyle = UIModalTransitionStyleFlipHorizontal;
   // [self presentViewController:iniciodiagramas animated:YES completion:NULL];
    
    UIStoryboard *InglesStoryboard = [UIStoryboard storyboardWithName:@"MainStoryboard" bundle:nil];
    
    UIViewController *InicioInglesStoryboard = [InglesStoryboard instantiateViewControllerWithIdentifier:@"Diagramas"];
