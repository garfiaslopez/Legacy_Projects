...
- (void)viewDidLoad
{
    ...
    Valores = [[NSMutableArray alloc]initWithObjects:@"220",@"330",@"1200", nil];
    NumResistencia = [[NSMutableArray alloc]initWithObjects:@"Resistencia 3",@"Resistencia 2",@"Resistencia 1", nil];
