...
- (void)viewDidLoad
{
    ...
    Hexalabeltxt.font = [UIFont fontWithName:@"Coming Soon" size:30];
    Decimallabeltxt.font = [UIFont fontWithName:@"Coming Soon" size:30];
    Binariolabeltxt.font = [UIFont fontWithName:@"Coming Soon" size:30];
    Octallabeltxt.font = [UIFont fontWithName:@"Coming Soon" size:30];
