...
- (void)viewDidLoad
{
    ...
    [UIView animateWithDuration:1.5 animations:^(){
            Tittle.frame = CGRectMake(0, 0, 320, 44);
        }];
    ...
    if ([ [ UIScreen mainScreen ] bounds ].size.height == 568){
        ...
        self.MainScroller.contentSize=CGSizeMake(320, 1020);
    }
    else{
        [MainScroller setScrollEnabled:YES];
        self.MainScroller.contentSize=CGSizeMake(320,1120);
    }
   ...
   [self.Tittle setTitleTextAttributes:@{UITextAttributeFont:[UIFont fontWithName:@"Coming Soon" size:22]}];
