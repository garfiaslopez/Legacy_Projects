...
- (void)viewDidLoad
{
    ...
    [self.TituloNav setTitleTextAttributes:@{UITextAttributeFont:[UIFont fontWithName:@"Coming Soon" size:18]}];
    
    UIFont *font = [UIFont fontWithName:@"Coming Soon" size:13];
    NSDictionary *attributes = [NSDictionary dictionaryWithObject:font
                                                           forKey:UITextAttributeFont];
    [unidades setTitleTextAttributes:attributes
                          forState:UIControlStateNormal];
    
    [unidades2 setTitleTextAttributes:attributes forState:UIControlStateNormal];
