...
-(IBAction)GotoPRO:(id)sender{
    ...
    [[UIApplication sharedApplication] openURL:[NSURL URLWithString:@"https://itunes.apple.com/us/app/ielectronic-tools-pro/id673951862?ls=1&mt=8"]];
    
}

- (IBAction)CargaResLED:(id)sender {
...
- (IBAction)CargaDecibel:(id)sender {
...
- (void)viewDidLoad
{
    ...
    if ([ [ UIScreen mainScreen ] bounds ].size.height == 568){
        ...
        self.MainScroller.contentSize=CGSizeMake(320, 810);
    }
    else{
        [MainScroller setScrollEnabled:YES];
        self.MainScroller.contentSize=CGSizeMake(320,910);
    }
    
    [self.Tittle setTitleTextAttributes:@{
                                          UITextAttributeFont:[UIFont fontWithName:@"SparTakus Round" size:11],
