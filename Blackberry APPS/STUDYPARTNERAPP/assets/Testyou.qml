        ...
        kindProperties: FreeFormTitleBarKindProperties {
            Container {
                ...
                Label {
                    ...
                    text: qsTr("How much do you know?")
                    textStyle {
                        color: Color.White
			        ...
			        Label {
                     ...
                     ImageView {
                         ...
                         translationX: 200
                          ...
                          preferredHeight: 120
                          preferredWidth: 120
                          imageSource: "/Imagenes/lifes score board.png"
                      }
			        Label {
			            translationY: 20
			            translationX: 520
                ...
                if(selection.selectedIndex == answArray[numrandom]){
                    ...
                    if (vidas == 0){
                        ...
                        if(score >= 0 && score < 200){
                            finalLabel.text = "¡You can do it better!"
                            gif1.visible = true;
                            gif2.visible = false;
                            gif3.visible = false;
                            gif4.visible = false;
                            ...
                            finalLabel.text = "¡Your getting better!"
                            gif1.visible = false;
                            gif2.visible = false;
                            gif3.visible = true;
                            gif4.visible = false;
             ...
             Container {
                 ...
                 Container {
                     ...
                     ImageView {
                         ...
                         preferredWidth: 700
                         preferredHeight: 800
                         imageSource: "Imagenes/CustomDialog.png"
                     }
                 ...
                 Container {
                     ...
                     ImageView {
                         ...
                         id: gif1
                         imageSource: "/Imagenes/cerebro1.gif"
                         attachedObjects: [
                             ImageAnimator {
                                 id: imageAnimator
                                 animatedImage: gif1.image
                                 started: true
                     ...
                     ImageView {
                         ...
                         id: gif2
                         imageSource: "/Imagenes/cerebro2.gif"
                         attachedObjects: [
                             ImageAnimator {
                                 id: imageAnimator2
                                 animatedImage: gif2.image
                                 started: true
                     ...
                     ImageView {
                         ...
                         id: gif3
                         imageSource: "/Imagenes/cerebro3.gif"
                         attachedObjects: [
                             ImageAnimator {
                                 id: imageAnimator3
                                 animatedImage: gif3.image
                                 started: true
                     ...
                     ImageView {
                         ...
                         id: gif4
                         imageSource: "/Imagenes/cerebro4.gif"
                         attachedObjects: [
                             ImageAnimator {
                                 id: imageAnimator4
                                 animatedImage: gif4.image
                                 started: true
