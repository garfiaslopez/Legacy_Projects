...
static const char qt_meta_stringdata_App[] = {
    "App\0\0reply\0onCreateTableReply(bb::data::DataAccessReply)\0"
    "bool\0createDatabase()\0dropTable()\0"
    "createTable()\0firstName,lastName\0"
...
void App::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->onCreateTableReply((*reinterpret_cast< const bb::data::DataAccessReply(*)>(_a[1]))); break;
        case 1: { bool _r = _t->createDatabase();
            if (_a[0]) *reinterpret_cast< bool*>(_a[0]) = _r; }  break;
        case 2: _t->dropTable(); break;
        case 3: _t->createTable(); break;
        case 4: _t->createRecord((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2]))); break;
        case 5: _t->createTableAsync(); break;
        default: ;
        }
    }
}
