		...
		<div class="row row-offcanvas row-offcanvas-left">
			<div class="col-md-2 sidebar-offcanvas" id="sidebar" role="navigation">
				<div id="barra" class="container">
                  ...
                  <li class="active"><a href="../pages/adminBanners.php"><i class="fa fa-bookmark-o"></i><span>  Banners</span></a></li>
			...
			<div class="col-md-9">
				<!--contenido-->
          		...
          		<div class="row placeholders" valing="middle">
            		<div class="col-md-5">
            			...
            			<h1 class="page-header" align="center">Cargar Banner</h1>
                ...
                <div class="col-md-2">
            		...
            		<div class="col-md-5">
              			<h1 class="page-header" align="center">Banners Recientes</h1>
